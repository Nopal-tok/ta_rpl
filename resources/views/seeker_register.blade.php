            ...
            <div class="register-login-card-content row justify-content-center">
                <div class="form-content col-12 col-lg-9 col-xl-7 p-4 shadow rounded bg-white">
                    ...
                    <div class="headline-text">
                        <p class="headline-text-content fw-semibold">Register</p>
                    </div>

                    <form class="text-start" action="/register-seeker" method="POST">
                        @csrf
                        ...
                        <div class="text-password-confirm fw-medium position-relative">
                            ...
                            <input type="password" class="form-control" id="confirmInput" name="password_confirmation" required>
